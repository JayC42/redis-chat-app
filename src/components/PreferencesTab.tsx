...
const PreferencesTab = () => {
    ...
    const [playMouseClick] = useSound("/sounds/mouse-click.mp3", { volume: 0.25 })
    const [playSoundOn] = useSound("/sounds/sound-on.mp3", { volume: 0.25 })
    const [playSoundOff] = useSound("/sounds/sound-off.mp3", { volume: 0.25 })
